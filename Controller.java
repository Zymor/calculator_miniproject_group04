...
public class Controller {
    ...
    @FXML
    void On_dive(ActionEvent event) {
    ...
    @FXML
    void On_mutiple(ActionEvent event) {

    }

    @FXML
    void On_nign(ActionEvent event) {
    ...
    @FXML
    void On_point(ActionEvent event) {
    ...
    @FXML
    void initialize() {
        assert Label_screen != null : "fx:id=\"Label_screen\" was not injected: check your FXML file 'View.fxml'.";
